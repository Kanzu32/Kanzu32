...
&nbsp;&nbsp;
<a href="https://www.linkedin.com/in/kanzu32"><img alt="LinkedIn" src="https://img.shields.io/badge/LinkedIn-Kanzu?style=for-the-badge&logoColor=%234285F4&labelColor=white&color=blue"></a>
...
| :---: | --- |
| **<h3>[Third person Action Platformer (GitHub)](https://github.com/Kanzu32/3D-Platformer)</h3> Third person platformer with enemies, combo-attacks and guard mechanics. Made using <ins>*Unity*</ins>.** | <img src="https://github.com/user-attachments/assets/3462fe14-5c3b-41c3-b065-6ab5de3a7fb2"> |
| **<h3>[Troublemakers! / Смутьяны! (GitHub)](https://github.com/Kanzu32/strategy-game)</h3> Client-server turn-based strategy game "Troublemakers" made in <ins>*Go*</ins> and <ins>*Ebitengine*</ins>. Uses [self-written implementation](https://github.com/Kanzu32/go-ecs) of the Entity-Component-System architectural pattern.** | <img src="https://github.com/user-attachments/assets/12a54472-a0a3-4eff-9977-c491a189c3d0"> |
| **<h3>[Pacman (GitHub)](https://github.com/Kanzu32/pacman)</h3> Clone of the PacMan written in <ins>*C++*</ins> and <ins>*Qt*</ins>. Has two players and solo mode, difficulty levels, music player, leaderboards, control settings, levels in txt format and other features.** | <img src="https://github.com/Kanzu32/pacman/blob/main/readme/pacman-2.png"> |
